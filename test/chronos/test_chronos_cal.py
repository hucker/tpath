...
from tpath.chronos import Chronos, Cal
...
def test_cal_with_chronos():
    ...
    reference_time = datetime(2024, 1, 1, 18, 0, 0)  # Same day, 6 hours later
...
def test_cal_win_minutes():
    ...
    reference_time = datetime(2024, 1, 1, 12, 35, 0)  # 5 minutes later
...
def test_cal_win_hours():
    ...
    reference_time = datetime(2024, 1, 1, 12, 30, 0)  # 2 hours later
...
def test_cal_win_days():
    ...
    target_time = datetime(2024, 1, 1, 12, 0, 0)
    reference_time = datetime(2024, 1, 2, 12, 0, 0)  # Next day
...
def test_cal_win_weeks():
    ...
    # Monday Jan 1, 2024
    target_time = datetime(2024, 1, 1, 12, 0, 0)  # Monday
    reference_time = datetime(2024, 1, 8, 12, 0, 0)  # Next Monday
...
def test_cal_win_weeks_custom_start():
    ...
    # Sunday Jan 7, 2024
    target_time = datetime(2024, 1, 7, 12, 0, 0)  # Sunday
    reference_time = datetime(2024, 1, 14, 12, 0, 0)  # Next Sunday
...
def test_cal_win_months():
    ...
    target_time = datetime(2024, 1, 15, 12, 0, 0)  # January 15
    reference_time = datetime(2024, 2, 15, 12, 0, 0)  # February 15
...
def test_cal_win_quarters():
    ...
    target_time = datetime(2024, 1, 15, 12, 0, 0)  # Q1 2024
    reference_time = datetime(2024, 4, 15, 12, 0, 0)  # Q2 2024
...
def test_cal_win_years():
    ...
    target_time = datetime(2023, 6, 15, 12, 0, 0)  # 2023
    reference_time = datetime(2024, 6, 15, 12, 0, 0)  # 2024
...
def test_cal_range_ordering():
    ...
    target_time = datetime(2024, 1, 3, 12, 0, 0)
...
def test_cal_single_vs_range():
    ...
    target_time = datetime(2024, 1, 1, 12, 0, 0)
    reference_time = datetime(2024, 1, 2, 12, 0, 0)
